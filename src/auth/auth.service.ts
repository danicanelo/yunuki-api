...
export class AuthService {
  ...
  async login(username: string, pass: string): Promise<any> {
    ...
    // Si la contraseña que hemos recibido como segundo parámetro de 'login' no coincide con la del usuario obtenido se lanza una excepción de No Autorizado. El interrogante tras 'user' evita que el programa detenga su ejecución si por la razón que fuese 'user' no dispusiera de una propiedad 'password' o ésta fuese nula o indefinida.
