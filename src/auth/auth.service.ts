...
export class AuthService {
  ...
  // Nuestro servicio de autenticación hace uso de un único método 'login' que recibe un nombre de usuario y una contraseña
  async login(username: string, pass: string): Promise<any> {
    ...
    // Si la contraseña que hemos recibido como segundo parámetro de 'login' no coincide con la del usuario obtenido se lanza una excepción de No Autorizado. El interrogante tras 'user' evita que el programa detenga su ejecución si por la razón que fuese no hubiese ningún usuario almacenado en la constante 'user'
