...
export class User {
  ...
  @Column({
    unique: true, // Indicamos que el valor de este campo debe ser único y no repetido en el resto de los registros de la tabla, haremos lo mismo con el campo email
  })
  username: string;
